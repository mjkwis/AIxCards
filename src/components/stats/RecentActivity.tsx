  ...
  if (requests.length === 0) {
    return (
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground text-center py-8">Brak aktywności w ostatnich dniach</p>
        </CardContent>
      </Card>
    );
  }
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center gap-4 text-muted-foreground">
                    <span>
                      {request.requests} request{request.requests !== 1 ? "y" : ""}
                    </span>
                ...
                <div className="h-2 bg-muted rounded-full overflow-hidden">
                  <div className="h-full bg-primary transition-all" style={{ width: `${barHeight}%` }} />
                </div>
              </div>
            );
          })}
